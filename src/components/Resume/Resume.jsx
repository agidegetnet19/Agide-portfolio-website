...
import './Resume.css';
import Agide_Resume from '../../assets/Agide_Resume.pdf';
    ...
    return (
        <section style={{ backgroundColor: " #fff3cd", height: "300px", alignItems: "center", paddingTop: "25px", marginBottom: "50px" }}>
            <Container id="resume" className="my-5"> <h2 className="text-center mb-4 ms-5" >View my resume</h2>
                ...
                <div id="button" className=" text-center mt-4 ms-5 ">  <Button href={Agide_Resume} download> Download resume </Button>
                </div>
            </Container>
        </section>
    );
